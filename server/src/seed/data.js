...
// Historical leads from the supplied client export. Their estimates are retained
// verbatim because they predate this application's documented calculation rule.
export const historicalLeads = [
  {
    source_id: "ld_1041",
